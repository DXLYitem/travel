...
public class AuIndex {
    ...
    public String auIndex(@RequestParam(required = true, defaultValue = "1") Integer page, Model model,
                          Integer themeId, Integer hobbyId, Integer travelId,
                          Integer trafficId, Integer styleId, Integer pn, String startTime,
                          Integer continentId, Integer countryId,Integer detailId,Integer brandId,Integer holidayId
        ...
        if (itemList.size() > 0 && strList.size() > 0 && travelList.size() > 0) {
            ...
            return "/www.sparkletour.com/AboutUs/index";
        }
