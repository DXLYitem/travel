 ...
 */
@Controller
public class ProductClubControl {
    @Resource
    ...
    public String product(@RequestParam(required=true,defaultValue="1") Integer page, Model model,
                          ...
                          Integer continentId, Integer countryId,Integer detailId,
                          Integer brandId,Integer holidayId) throws ParseException {
        ...
        return "/www.sparkletour.com/ProductClub";
    }
}
