 ...
 */
@Controller
public class InvitationListControl {
    @Resource
    ...
    public String invitat(@RequestParam(required=true,defaultValue="1") Integer page, Model model,
        ...
        return "/www.sparkletour.com/InvitationList";
    }
}
